      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbarContent">
          <ul class="navbar-nav ml-auto pt-3 pt-lg-0">
            ...
            <li class="nav-item">
              <a href="article/new" class="nav-link">Modifier Article</a>
            </li>

            <li class="nav-item active">
              <a href="contact.html" class="nav-link">Déconnexion</a>
            </li>
          </ul>
        </div>
      </div> <!-- .container -->
      ...
      <div class="container h-100">
        <div class="row justify-content-center align-items-center h-100">
          <div class="col-lg-8">
            ...
            <h1 class="fg-white text-center">Modifier Article</h1>
          </div>
        </div>
      </div>
    </div> <!-- .page-banner -->
    ...
    <div class="page-section">
      <div class="container">
        ...
        <div class="row justify-content-center mt-5">
          <div class="col-lg-8">
            <form action="/article/modifier" method="post" enctype="multipart/form-data" class="form-contact">
                @csrf
              <div class="row">
                <div class="col-sm-6 py-2">
                  <label for="titre" class="fg-grey">Titre</label>
                  <input type="text" class="form-control" name="titre" id="titre" value="{{$article->titre}}" placeholder="Enter name..">
                </div>
                <input type="hidden"  name="id" value="{{$article->id}}">
                <img src="{{Storage::url($article->image)}}" alt="image"  width="500px" height="300px">
                <div class="col-sm-6 py-2">
                ...
                <div class="col-12 py-2">
                  ...
                  <textarea id="message" rows="8" name="resume" class="form-control" placeholder="Enter le résumé ">{{$article->resume}}</textarea>
                </div>
                <div class="col-12 py-2">
                    <label for="Contenu" class="fg-grey">Contenu</label>
                    <textarea class="form-control" name="contenu" id="editor">{!! html_entity_decode($article->contenu) !!}</textarea>
                </div>
