            ...
            <form action="login" method="post" class="form-contact">
              ...
              <div class="row">
                <div class="col-sm-6 py-2">
                  ...
                  <input type="text" class="form-control" name="nom" id="name" placeholder="Enter name..">
                </div>
                <div class="col-sm-6 py-2">
                  <label for="email" class="fg-grey">Mot de passe</label>
                  <input type="password" class="form-control" name="mdp" id="email" placeholder="password">
                </div>
