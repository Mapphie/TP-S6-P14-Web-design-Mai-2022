...
<body>
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      <div class="container">
        <strong><a href="index.html" class="navbar-brand">I<span class="text-primary">A</span></a></strong>
          ...
          <ul class="navbar-nav ml-auto pt-3 pt-lg-0">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item active">
                <a href="{{route('deconnexion')}}" class="nav-link">Déconnexion</a>
              </li>
          </ul>
        </div>
      </div> <!-- .container -->
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-lg-4 py-3">
                <div class="card-blog">
                  ...
                  <div class="body">
                    <div class="post-title"><a href="Intelligence-artificielle/article-get-{{$articles[$i]->id}}"><h1>{{$articles[$i]->titre}}</h1></a></div>
                    <div class="post-excerpt">{{ $articles[$i]->resume }}</div>
                  </div>
                  <div class="footer">
                    <a href="Intelligence-artificielle/article-get-{{$articles[$i]->id}}">Voir <span class="mai-chevron-forward text-sm"></span></a>
                    <a href="Intelligence-artificielle/article/modif/{{$articles[$i]->id}}">Modifier <span class="mai-chevron-forward text-sm"></span></a>


                    <button onclick="PopUpSupp({{$articles[$i]->id}})"  class="btn" style="border-radius: 12px;background-color: lightseagreen;">
                        Supp
                      </button>
                  </div>
